...
var filterShader = new EcognitaMathLib.WebGL_Shader(Shaders,"grayScaleFilter-vert", "grayScaleFilter-frag");
...
uniLocation_s.push(filterShader.uniformIndex('grayScale'));
